      ...
      <div className="max-w-sm mx-auto px-4 py-8 space-y-6 relative z-10">
        ...
        <Card className="retro-card border-0 rounded-3xl overflow-hidden">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-bold text-primary retro-title mb-2">
            ...
            <div className="space-y-4 mt-6">
              <Button
                ...
                onClick={() => setLocation('/create-league-form')}
              ...
              <Button
                className="w-full retro-red-gradient retro-button rounded-xl h-14 text-base font-bold text-white border-0"
                onClick={() => setLocation('/join-league')}
          ...
          <CardContent className="space-y-6 px-8 pb-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                data-testid="button-create-league-submit"
              >
